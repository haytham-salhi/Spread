...
package com.spread.experiment.tempuntilofficialrelease;
 ...
 * @version $Revision$
 */
public class ClassificationViaClustering108 extends AbstractClassifier {
   ...
   * default constructor
   */
  public ClassificationViaClustering108() {
    super();
  ...
  public static void main(String[] args) {
    runClassifier(new ClassificationViaClustering108(), args);
  }
}