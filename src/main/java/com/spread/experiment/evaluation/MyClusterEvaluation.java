 ...
 * 
 * 
 * Nothing but I preserved the cluster to classes mapping in <-- 
 * 
 * 
 * 
 */
 ...
 */
public class MyClusterEvaluation implements Serializable, RevisionHandler {

  /** for serialization */
  static final long serialVersionUID = -830188327319128005L;
  
  // Begin: Haytham's changes
  public Map<String, String> clustersToClassesMapping = new HashMap<>();
  // End: Haytham's changes
    ...
    for (i = 0; i < m_numClusters; i++) {
      if (clusterTotals[i] > 0) {
        ...
        if (best[i] < 0) {
          ...
          // Begin: Haytham's changes
          clustersToClassesMapping.put("Cluster "
          + i, "No class");
          // End: Haytham's changes
        } else {
          m_clusteringResults
          ...
          // Begin: Haytham's changes
          clustersToClassesMapping.put("Cluster "
          + i, inst.classAttribute().value((int) best[i]));
          // End: Haytham's changes
        }
      }
    }
  ...
  public static String evaluateClusterer(Clusterer clusterer, String[] options)
    ...
    if (objectInputFileName.length() != 0) {
      ...
      if (theClass == -1) {
        ...
        MyClusterEvaluation ce = new MyClusterEvaluation();
  ...
  public boolean equals(Object obj) {
    ...
    MyClusterEvaluation cmp = (MyClusterEvaluation) obj;
